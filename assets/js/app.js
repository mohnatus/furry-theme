...
},{}],"js/utils/keyboard.js":[function(require,module,exports) {
"use strict";
...
function Drawer() {
  ...
  (0, _keyboard.onKeyDown)(_keyboard.ESCAPE_KEY, function () {
    closeMenu();
  });
}
},{"./utils/keyboard":"js/utils/keyboard.js"}],"js/utils/dom.js":[function(require,module,exports) {
"use strict";
...
var loaderHTML = '<svg width="64" height="64"><use xlink:href="#loader-icon" href="#loader-icon"></use></svg>';

function Loader() {
  var el = (0, _dom.node)('div', {
    class: 'loader '
  }, null, loaderHTML);
  return {
    el: el,
...
},{"./dom":"js/utils/dom.js"}],"js/advert/ablock.js":[function(require,module,exports) {
"use strict";
...
var _ref = window.adata ? window.adata.google : {},
    client = _ref.client,
    config = _ref.config;

var className = 'a-block';
var loadingClassName = 'a-block--loading';
...
function ABlock(el, name) {
  ...
  var loader = (0, _loader.Loader)();
  el.appendChild(loader.el);
  el.classList.add(loadingClassName);

  var attrs = _objectSpread({}, insAttrs, {}, config[name]);
...
},{"../utils/dom":"js/utils/dom.js","../utils/loader":"js/utils/loader.js"}],"js/advert/init.js":[function(require,module,exports) {
"use strict";
...
function ASet() {
  ...
  var googleData = window.adata.google;
  var blocks = googleData.blocks || {};
  window.adsbygoogle = window.adsbygoogle || [];
  var loading = new Promise(function (res, rej) {
    var s = (0, _dom.script)(url, res, rej);
    document.body.appendChild(s);
  });

  if (isSingular()) {
    if (blocks.inPost) setInPost();else if (blocks.header) setTop();
  } else {
    if (blocks.header) setTop();
  }

  if (blocks.footer) setBottom();
  (0, _observer.registerObserver)('[data-a-block]', function (b) {
    var name = b.dataset.aName;
    if (!name) return;
    var aBlock = (0, _ablock.ABlock)(b, name);
    window.adsbygoogle.push({});
    loading.then(function () {
      return aBlock.loaded = true;
    }).catch(function () {
      return aBlock.error = true;
    });
  });
}
},{"./ablock":"js/advert/ablock.js","../utils/dom":"js/utils/dom.js","../observer":"js/observer.js"}],"js/utils/onLoad.js":[function(require,module,exports) {
"use strict";
...
function onLoad(cb) {
  if (window.contentLoaded) cb();else {
...
exports.loadAsyncStyles = loadAsyncStyles;
...
function loadAsyncStyles() {
  var links = _toConsumableArray(document.querySelectorAll('[data-async-style]'));
...
},{}],"js/analytics/init.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.AnalyticsTurnOn = AnalyticsTurnOn;

function AnalyticsTurnOn() {
  if (!window.adata || !window.adata.yandex || !window.adata.yandex.id) return;
  var id = window.adata.yandex.id;
...
var _onLoad = require("./js/utils/onLoad");

var _styles = require("./js/styles");

var _init2 = require("./js/analytics/init");
...
(0, _onLoad.onLoad)(_styles.loadAsyncStyles);
(0, _onLoad.onScroll)(_init2.AnalyticsTurnOn);
(0, _onLoad.onLoad)(_init.ASet);
},{"./js/observer":"js/observer.js","./js/drawer":"js/drawer.js","./js/advert/init":"js/advert/init.js","./js/utils/onLoad":"js/utils/onLoad.js","./js/styles":"js/styles.js","./js/analytics/init":"js/analytics/init.js"}],"../../../../../../../Users/catinweb/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
